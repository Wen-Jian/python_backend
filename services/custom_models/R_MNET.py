...
# from tf.keras.layers import Input, Dense, Flatten, Dropout, Concatenate, Multiply, Lambda, Add
...
# from tf.keras.layers.convolutional import UpSampling2D, Conv2D,MaxPooling2D,Conv2DTranspose
