...
class Wgan:
    ...
    def __init__(self, input_shape, batch_size):
        self.checkpoint_path = 'trained_parameters/wgan/3x3_512/'
        ...
        self.auto_encoder = self.make_auto_encoder()
        if os.path.isfile(self.checkpoint_path + "autoencoder/ckpt_autoencoder.index"):
            self.auto_encoder.load_weights(self.checkpoint_path + "autoencoder/ckpt_autoencoder")
    ...
    def make_generator(self, input_shape, output_shape):
        ...
        return tf.keras.Sequential([
            ...
            # layers.Dense(width*height*128, use_bias=False, input_shape=input_shape),
            # layers.BatchNormalization(),
            # layers.LeakyReLU(),
            # layers.Reshape((width, height, 128)),
